...
public class TC09_AddingBookToCurrentlyReading {
    ...
    public void testAddingBookToCurrentlyReading() throws IOException {
        ...
        addBookToCurrentlyReading.clickShelvesList().clickCurrentlyReading();

        Assert.assertTrue(addBookToCurrentlyReading.assertCurrentlyReading());
    }
