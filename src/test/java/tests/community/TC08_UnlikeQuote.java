...
public class TC08_UnlikeQuote {
    ...
    public void testLikeQuote() throws IOException {
        ...
        P02_Community unLikeQuote = new P02_Community(getDriver());
        unLikeQuote.openCommunityDropdown()
                .clickQuotes()
                .clickMyQuotes()
                .clickUnLike()
                .handleAlert();

        Assert.assertTrue(unLikeQuote.assertQuotesPage());
